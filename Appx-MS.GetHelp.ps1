...
##### CUSTOM COMMANDS AFTER WinGet is Verified #####
# Remove Old Get.Help
winget uninstall 9PKDZBMV1H3T --silent
# Install Latets Get.Help
winget install 9PKDZBMV1H3T --silent --disable-interactivity --accept-package-agreements --accept-source-agreements --nowarn --force
